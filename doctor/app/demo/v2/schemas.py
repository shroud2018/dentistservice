...
definitions = {'definitions': {'doctor': {'type': 'object', 'properties': {'name': {'type': 'string', 'example': 'Cris Wu'}, 'location': {'type': 'string', 'example': '2nd Floor'}, 'level': {'type': 'string', 'example': 'GP'}}}, 'doctors': {'type': 'array', 'items': {'$ref': '#/definitions/doctor'}}}, 'parameters': {}}

validators = {
    ('getadoctor', 'GET'): {'args': {'required': ['Doctorname'], 'properties': {'Doctorname': {'type': 'string'}}}},
}

filters = {
    ('getall', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/doctors'}}},
    ('getadoctor', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/doctor'}}},
}
