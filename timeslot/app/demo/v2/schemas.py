...
definitions = {'definitions': {'timetable': {'type': 'object', 'properties': {'name': {'type': 'string', 'example': 'Cris Wu'}, 'time': {'type': 'string', 'example': '10:00'}}}, 'doctor': {'type': 'object', 'properties': {'name': {'type': 'string', 'example': 'Cris Wu'}}}, 'timetable1': {'type': 'array', 'items': {'$ref': '#/definitions/timetable'}}}, 'parameters': {}}

validators = {
    ('reverse', 'POST'): {'json': {'$ref': '#/definitions/timetable'}},
    ('doctor_avaliable', 'GET'): {'args': {'required': ['Doctorname'], 'properties': {'Doctorname': {'type': 'string'}}}},
    ('cancel', 'POST'): {'json': {'$ref': '#/definitions/timetable'}},
}

filters = {
    ('reverse', 'POST'): {200: {'headers': None, 'schema': None}},
    ('reverse', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/timetable1'}}},
    ('doctor_avaliable', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/timetable1'}}},
    ('cancel', 'POST'): {200: {'headers': None, 'schema': None}},
}
